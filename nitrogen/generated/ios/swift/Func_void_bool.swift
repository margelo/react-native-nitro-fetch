...
/**
 * Wraps a Swift `(_ finalChunk: Bool) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_bool {
  public typealias bridge = margelo.nitro.nitrofetch.bridge.swift

  private let closure: (_ finalChunk: Bool) -> Void

  public init(_ closure: @escaping (_ finalChunk: Bool) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(finalChunk: Bool) -> Void {
    self.closure(finalChunk)
  }
