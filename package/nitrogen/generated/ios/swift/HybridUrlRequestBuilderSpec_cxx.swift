...
open class HybridUrlRequestBuilderSpec_cxx {
  ...
  @inline(__always)
  public final func setUploadBodyFormData(parts: bridge.std__vector_NitroFormDataPart_) -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.setUploadBodyFormData(parts: { () -> [NitroFormDataPart] in
        let __data = bridge.get_data_std__vector_NitroFormDataPart_(parts)
        let __size = parts.size()
