...
namespace margelo::nitro::nitrofetchwebsockets {
  ...
  /**
   * An abstract base class for `NitroWebSocket`
   * Inherit this class to create instances of `HybridNitroWebSocketSpec` in C++.
   * You must explicitly call `HybridObject`'s constructor yourself, because it is virtual.
   * @example
   * ```cpp
   * class HybridNitroWebSocket: public HybridNitroWebSocketSpec {
   * public:
   *   HybridNitroWebSocket(...): HybridObject(TAG) { ... }
   *   // ...
   * };
   * ```
   */
  class HybridNitroWebSocketSpec: public virtual HybridObject {
    public:
      // Constructor
      explicit HybridNitroWebSocketSpec(): HybridObject(TAG) { }

      // Destructor
      ~HybridNitroWebSocketSpec() override = default;
    ...
    protected:
      // Tag for logging
      static constexpr auto TAG = "NitroWebSocket";
  };
