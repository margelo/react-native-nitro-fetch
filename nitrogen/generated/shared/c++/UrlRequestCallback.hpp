...
namespace margelo::nitro::nitrofetch {
  ...
  public:
    ...
    std::function<void(const std::optional<UrlResponseInfo>& /* info */, const CronetException& /* error */)> onFailed     SWIFT_PRIVATE;
    std::function<void(const std::optional<UrlResponseInfo>& /* info */)> onCanceled     SWIFT_PRIVATE;

  public:
    UrlRequestCallback() = default;
    explicit UrlRequestCallback(std::function<void(const UrlResponseInfo& /* info */, const std::string& /* newLocationUrl */)> onRedirectReceived, std::function<void(const UrlResponseInfo& /* info */)> onResponseStarted, std::function<void(const UrlResponseInfo& /* info */, const std::shared_ptr<ArrayBuffer>& /* byteBuffer */)> onReadCompleted, std::function<void(const UrlResponseInfo& /* info */)> onSucceeded, std::function<void(const std::optional<UrlResponseInfo>& /* info */, const CronetException& /* error */)> onFailed, std::function<void(const std::optional<UrlResponseInfo>& /* info */)> onCanceled): onRedirectReceived(onRedirectReceived), onResponseStarted(onResponseStarted), onReadCompleted(onReadCompleted), onSucceeded(onSucceeded), onFailed(onFailed), onCanceled(onCanceled) {}
  };
  ...
  struct JSIConverter<margelo::nitro::nitrofetch::UrlRequestCallback> final {
    static inline margelo::nitro::nitrofetch::UrlRequestCallback fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::nitrofetch::UrlRequestCallback(
        ...
        JSIConverter<std::function<void(const std::optional<margelo::nitro::nitrofetch::UrlResponseInfo>&, const margelo::nitro::nitrofetch::CronetException&)>>::fromJSI(runtime, obj.getProperty(runtime, "onFailed")),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrofetch::UrlRequestCallback& arg) {
      ...
      obj.setProperty(runtime, "onFailed", JSIConverter<std::function<void(const std::optional<margelo::nitro::nitrofetch::UrlResponseInfo>&, const margelo::nitro::nitrofetch::CronetException&)>>::toJSI(runtime, arg.onFailed));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::function<void(const std::optional<margelo::nitro::nitrofetch::UrlResponseInfo>&, const margelo::nitro::nitrofetch::CronetException&)>>::canConvert(runtime, obj.getProperty(runtime, "onFailed"))) return false;
