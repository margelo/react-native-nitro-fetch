...
- Once slow APIs are identified — usual fixes: [`nitro-fetch-prefetching`](./prefetching.md), [`nitro-fetch-websocket-prewarm`](./websocket-prewarm.md)
