...
struct JHybridNitroFetchSpecImpl: public jni::JavaClass<JHybridNitroFetchSpecImpl, JHybridNitroFetchSpec::JavaPart> {
  static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitrofetch/NitroFetch;";
  static std::shared_ptr<JHybridNitroFetchSpec> create() {
    static auto constructorFn = javaClassStatic()->getConstructor<JHybridNitroFetchSpecImpl::javaobject()>();
...
struct JHybridNitroFetchClientSpecImpl: public jni::JavaClass<JHybridNitroFetchClientSpecImpl, JHybridNitroFetchClientSpec::JavaPart> {
  static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitrofetch/NitroFetchClient;";
  static std::shared_ptr<JHybridNitroFetchClientSpec> create() {
    static auto constructorFn = javaClassStatic()->getConstructor<JHybridNitroFetchClientSpecImpl::javaobject()>();
...
struct JHybridNativeStorageSpecImpl: public jni::JavaClass<JHybridNativeStorageSpecImpl, JHybridNativeStorageSpec::JavaPart> {
  static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitrofetch/NativeStorage;";
  static std::shared_ptr<JHybridNativeStorageSpec> create() {
    static auto constructorFn = javaClassStatic()->getConstructor<JHybridNativeStorageSpecImpl::javaobject()>();
