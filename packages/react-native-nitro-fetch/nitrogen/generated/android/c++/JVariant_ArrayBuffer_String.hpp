...
namespace margelo::nitro::nitrofetch {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrofetch/Variant_ArrayBuffer_String;";
  ...
  namespace JVariant_ArrayBuffer_String_impl {
    class First final: public jni::JavaClass<First, JVariant_ArrayBuffer_String> {
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrofetch/Variant_ArrayBuffer_String$First;";
    ...
    class Second final: public jni::JavaClass<Second, JVariant_ArrayBuffer_String> {
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrofetch/Variant_ArrayBuffer_String$Second;";
