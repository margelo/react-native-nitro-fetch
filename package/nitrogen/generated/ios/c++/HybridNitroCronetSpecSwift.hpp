...
namespace margelo::nitro::nitrofetch {
  ...
  public:
    ...
    inline SyncFetchResponse fetchSync(const std::string& url, const std::string& httpMethod, const std::unordered_map<std::string, std::string>& headers, const std::optional<std::string>& body) override {
      auto __result = _swiftPart.fetchSync(url, httpMethod, headers, body);
      if (__result.hasError()) [[unlikely]] {
        std::rethrow_exception(__result.error());
      }
      auto __value = std::move(__result.value());
