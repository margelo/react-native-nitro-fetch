...
namespace margelo::nitro::nitrofetch {
   ...
   */
  struct CachedFetchResponse final {
  public:
  ...
  public:
    friend bool operator==(const CachedFetchResponse& lhs, const CachedFetchResponse& rhs) = default;
  };
  ...
  struct JSIConverter<margelo::nitro::nitrofetch::CachedFetchResponse> final {
    static inline margelo::nitro::nitrofetch::CachedFetchResponse fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::nitrofetch::CachedFetchResponse(
        ...
        JSIConverter<std::shared_ptr<ArrayBuffer>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "body")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrofetch::CachedFetchResponse& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "body"), JSIConverter<std::shared_ptr<ArrayBuffer>>::toJSI(runtime, arg.body));
      return obj;
    }
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::shared_ptr<ArrayBuffer>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "body")))) return false;
      return true;
    }
  };
