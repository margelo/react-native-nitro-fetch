...
/**
 * Represents an instance of `SyncFetchResponse`, backed by a C++ struct.
 */
public typealias SyncFetchResponse = margelo.nitro.nitrofetch.SyncFetchResponse

public extension SyncFetchResponse {
  private typealias bridge = margelo.nitro.nitrofetch.bridge.swift

  /**
   * Create a new instance of `SyncFetchResponse`.
   */
  init(url: String, status: Double, statusText: String, headers: Dictionary<String, String>, body: String) {
