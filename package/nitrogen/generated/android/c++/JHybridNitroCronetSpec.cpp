...
#include "JSyncFetchResponse.hpp"
#include <string>
...
namespace margelo::nitro::nitrofetch {
  ...
  SyncFetchResponse JHybridNitroCronetSpec::fetchSync(const std::string& url, const std::string& httpMethod, const std::unordered_map<std::string, std::string>& headers, const std::optional<std::string>& body) {
    static const auto method = javaClassStatic()->getMethod<jni::local_ref<JSyncFetchResponse>(jni::alias_ref<jni::JString> /* url */, jni::alias_ref<jni::JString> /* httpMethod */, jni::alias_ref<jni::JMap<jni::JString, jni::JString>> /* headers */, jni::alias_ref<jni::JString> /* body */)>("fetchSync");
    auto __result = method(_javaPart, jni::make_jstring(url), jni::make_jstring(httpMethod), [&]() -> jni::local_ref<jni::JMap<jni::JString, jni::JString>> {
      auto __map = jni::JHashMap<jni::JString, jni::JString>::create(headers.size());
      for (const auto& __entry : headers) {
        __map->put(jni::make_jstring(__entry.first), jni::make_jstring(__entry.second));
      ...
      return __map;
    }(), body.has_value() ? jni::make_jstring(body.value()) : nullptr);
