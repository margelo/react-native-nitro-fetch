...
namespace margelo::nitro::nitrofetch {
  ...
  class HybridNitroCronetSpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual SyncFetchResponse fetchSync(const std::string& url, const std::string& httpMethod, const std::unordered_map<std::string, std::string>& headers, const std::optional<std::string>& body) = 0;
